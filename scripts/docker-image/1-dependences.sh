...
SVG_ICONS_DIR="$WORK_DIR/public/assets/images/icons"
...
https://github.com/symfony/yaml/archive/refs/tags/v8.0.6.zip#yaml-8.0.6#$WORK_DIR/app/ThirdParty/SymfonyYAML-v8.0.6
EOF
)
...
composer create-project 'codeigniter4/framework:4.6.3' "$WORK_DIR"
